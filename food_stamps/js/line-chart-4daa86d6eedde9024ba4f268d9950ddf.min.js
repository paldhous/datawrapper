 ...
 * generated on 2014-12-17T03:54:08+01:00
 */
...
if(vis.get('user-change-scale',false))addScaleChangeUI();if(vis.get('annotate-time-axis'))annotateTime(vis.get('annotate-time-axis'));vis.renderingComplete();if(axesDef.y1.length>1&&!lineLabelsVisible()){vis.notify(vis.translate('tooManyLinesToLabel'));}
