 ...
 * generated on 2016-05-29T04:30:23+02:00
 */
/*! datawrapper - v1.10.3 */
...
var strokeColor=lineColor(col);all_paths.push(paths);_.each(paths,renderPath);renderMissingValueConnections();if(x<maxX)x=maxX;if(lineLabelsVisible())renderLabels();return x;function buildPathPoints(val,i){if(!_.isNumber(val)){if(pts.length>0){pts_.push(pts);pts=[];}
return;}
